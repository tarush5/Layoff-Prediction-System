      ...
      <div className="w-full max-w-md space-y-8">
        ...
        <div className="text-center space-y-4">
          ...
          <div className="space-y-2">
            ...
            <p className="text-muted-foreground">Sign in to access your career risk assessment</p>
          </div>
        </div>
        ...
        {/* Footer */}
        <div className="text-center text-xs text-muted-foreground">Secure career risk assessment powered by AI</div>
      </div>
    </div>
  )
}
